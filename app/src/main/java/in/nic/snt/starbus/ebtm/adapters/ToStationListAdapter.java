...
public class ToStationListAdapter extends  RecyclerView.Adapter<ToStationListAdapter.StationListAdapterViewHolder>{

    Context context;
    List<StationsModel> stationsModelList;
    StationsOnClicks stationsOnClicks;

    public ToStationListAdapter(Context context, List<StationsModel> stationsModelList, StationsOnClicks stationsOnClicks) {
    ...
    @NonNull
    @Override
    public ToStationListAdapter.StationListAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ToStationListAdapter.StationListAdapterViewHolder(StationListBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull ToStationListAdapter.StationListAdapterViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (stationsOnClicks != null) {
                    stationsOnClicks.selectToStation(position,stationsModelList.get(position));
                }
            }
        });
    }
